...
final class ModuleRegistry
{
    ...
    public static function navigation(): array
    {
        return [
            ...
            ['key' => 'categories', 'label' => 'Catégories', 'icon' => 'tag', 'permission' => 'products.manage'],
            ['key' => 'brands', 'label' => 'Marques', 'icon' => 'tag', 'permission' => 'products.manage'],
            ['key' => 'suppliers', 'label' => 'Fournisseurs', 'icon' => 'truck', 'permission' => 'products.manage'],
            ['key' => 'product-variants', 'label' => 'Variantes', 'icon' => 'layers', 'permission' => 'products.manage'],
            ['key' => 'product-images', 'label' => 'Images produit', 'icon' => 'image', 'permission' => 'products.manage'],
            ['key' => 'warehouses', 'label' => 'Entrepôts', 'icon' => 'home', 'permission' => 'stock.manage'],
            ['key' => 'stock', 'label' => 'Stocks', 'icon' => 'layers', 'permission' => 'stock.manage'],
            ['key' => 'stock-movements', 'label' => 'Mouvements stock', 'icon' => 'shuffle', 'permission' => 'stock.manage'],
            ['key' => 'transfers', 'label' => 'Transferts', 'icon' => 'shuffle', 'permission' => 'transfers.manage'],
            ['key' => 'transfer-items', 'label' => 'Lignes transfert', 'icon' => 'list', 'permission' => 'transfers.manage'],
            ['key' => 'pos', 'label' => 'POS Caisse', 'icon' => 'terminal', 'permission' => 'pos.use'],
            ['key' => 'orders', 'label' => 'Commandes', 'icon' => 'receipt', 'permission' => 'analytics.view'],
            ['key' => 'order-items', 'label' => 'Lignes commande', 'icon' => 'list', 'permission' => 'analytics.view'],
            ['key' => 'payments', 'label' => 'Paiements', 'icon' => 'credit', 'permission' => 'pos.use'],
            ['key' => 'tickets', 'label' => 'Tickets SAV', 'icon' => 'message', 'permission' => 'tickets.manage'],
            ['key' => 'ticket-messages', 'label' => 'Messages SAV', 'icon' => 'message', 'permission' => 'tickets.manage'],
            ['key' => 'employees', 'label' => 'Employés', 'icon' => 'users', 'permission' => 'hr.manage'],
            ['key' => 'departments', 'label' => 'Départements', 'icon' => 'users', 'permission' => 'hr.manage'],
            ['key' => 'attendance', 'label' => 'Présence', 'icon' => 'clock', 'permission' => 'hr.manage'],
            ['key' => 'leaves', 'label' => 'Congés', 'icon' => 'calendar', 'permission' => 'hr.manage'],
            ['key' => 'salaries', 'label' => 'Salaires', 'icon' => 'receipt', 'permission' => 'hr.manage'],
            ['key' => 'employee-documents', 'label' => 'Docs RH', 'icon' => 'file', 'permission' => 'hr.manage'],
            ...
            ['key' => 'invoices', 'label' => 'Factures', 'icon' => 'receipt', 'permission' => 'accounting.manage'],
            ['key' => 'expenses', 'label' => 'Dépenses', 'icon' => 'receipt', 'permission' => 'accounting.manage'],
            ['key' => 'notifications', 'label' => 'Notifications', 'icon' => 'bell', 'permission' => 'notifications.manage'],
            ['key' => 'roles', 'label' => 'Rôles', 'icon' => 'shield', 'permission' => 'users.manage'],
            ['key' => 'permissions', 'label' => 'Permissions', 'icon' => 'shield', 'permission' => 'users.manage'],
        ];
    }
